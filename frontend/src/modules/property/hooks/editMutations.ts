...
import { deleteDocument, updateDocumentTitle, uploadDocument } from "@/modules/document/api/api";
import { deleteImages, updateImages, uploadImages } from "@/modules/image/api/api";
import { updateLocation } from "@/modules/location/api/api";
import { createArea, deleteArea, updateArea } from "@/modules/location/map/api/api";
import type { ResponseProperty, ResponseGetProperty, ResponseGetProperties } from "@/modules/property/types/types";
import type { PropertyArea } from "@/modules/location/map/types/types";
import { runSaveSteps, type SaveStep } from "../services/saveProgress";
import { getById, remove } from "../api/api";
