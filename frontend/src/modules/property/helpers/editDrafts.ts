...
import type { PropertyLocationDraft, PropertyLocationPayload } from "@/modules/location/types/types";
import { buildLocationPayload, createDefaultLocationDraft } from "@/modules/location/types/types";
import type { PropertyArea, PropertyAreaDraft, PropertyAreaPayload } from "@/modules/location/map/types/types";
import { buildAreaPayload } from "@/modules/location/map/helpers/areaDraft";
...
export type EditPropertyInput = {
  ...
  imageChanges: {
    newImages: import("@/modules/image/types/types").NewImageFile[];
    updatedImages: import("@/modules/image/types/types").UpdateImageInput[];
  ...
  onProgress?: (progress: import("../types/types").SavePropertyProgress) => void;
