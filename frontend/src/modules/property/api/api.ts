...
import { 
    ...
    type ResponseGetProperties } from "@/modules/property/types/types";
import { type CreatePropertyInput } from "../types/types";

import { validatePropertyMap } from "@/modules/location/map/helpers/validatePropertyMap";
